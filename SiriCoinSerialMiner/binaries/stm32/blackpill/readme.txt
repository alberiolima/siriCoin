>>> Using stm32CubeProg.sh (path /home/user/.arduino15/packages/STMicroelectronics/tools/STM32Tools/2.1.1/)
sh stm32CubeProg.sh 0 minerSiriSerial.ino.bin -g 

address file
0       minerSiriSerial.bin
